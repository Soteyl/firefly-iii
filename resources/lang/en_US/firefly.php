...
return [
    ...
    'restore'                                             => 'Restore',
    'deleted_imported_transactions'                       => 'Deleted imported transactions',
    'deleted_imported_transactions_empty'                 => 'No deleted imported transactions found.',
    'deleted_imported_transaction_restored'               => 'The imported transaction has been restored.',
    'deleted_imported_transaction_not_found'              => 'The deleted imported transaction could not be found.',
    'edit'                                                => 'Edit',
    'loading'                                             => 'Loading',
    ...
    'connect_monobank_help'                               => 'Paste your Monobank personal token. You can generate it in the Monobank mobile app under More -> Personal token for API. Firefly III will validate it and fetch available accounts.',
    'monobank_token'                                      => 'Monobank token',
    'connect_revolut'                                     => 'Connect Revolut',
    'connect_revolut_help'                                => 'Connect Revolut either via Enable Banking (recommended) or by manual token and device ID.',
    'connect_revolut_enable_banking_help'                 => 'Enable Banking flow: upload your application private key, start authorization, and after consent in Revolut you will be redirected back automatically.',
    'connect_revolut_manual_help'                         => 'Manual fallback: paste token and device ID from a signed-in Revolut mobile app session.',
    'revolut_token'                                       => 'Revolut token',
    'revolut_device_id'                                   => 'Revolut device ID',
    'revolut_enable_banking_step_1'                       => 'Enable Banking step 1: create authorization URL',
    'revolut_enable_banking_step_2'                       => 'Enable Banking step 2: finish with redirect URL',
    'revolut_enable_banking_step_upload'                  => 'Enable Banking key upload (.pem)',
    'revolut_enable_banking_uploaded_keys'                => 'Uploaded Enable Banking applications',
    'revolut_enable_banking_no_uploaded_keys'             => 'No valid uploaded Enable Banking keys yet.',
    'revolut_enable_banking_select_app'                   => 'Select uploaded application',
    'revolut_enable_banking_app_id'                       => 'Enable Banking application ID (kid)',
    'revolut_enable_banking_private_key_path'             => 'Private key path on server',
    'revolut_enable_banking_private_key_file'             => 'Private key file (.pem)',
    'revolut_enable_banking_country'                      => 'Revolut country',
    'revolut_enable_banking_upload_key'                   => 'Upload key',
    'revolut_enable_banking_start_auth'                   => 'Start authorization',
    'revolut_enable_banking_callback_info'                => 'After authorization in Revolut, this page will be opened automatically with the connection result.',
    'revolut_enable_banking_complete_auth'                => 'Complete and connect',
    'revolut_enable_banking_redirect_url'                 => 'Redirect URL returned after consent',
    'revolut_enable_banking_auth_started'                 => 'Authorization URL created: :url',
    'revolut_enable_banking_key_uploaded'                 => 'Enable Banking key uploaded for :application (:kid).',
    'revolut_enable_banking_callback_missing_app'         => 'Missing or invalid application ID in callback URL.',
    'revolut_enable_banking_invalid_pem'                  => 'Uploaded file is not a valid PEM private key.',
    'revolut_enable_banking_invalid_file_name'            => 'PEM filename must contain the Enable Banking application ID (UUID).',
    'save_and_refresh_accounts'                           => 'Save and refresh accounts',
    'no_bank_connections_yet'                             => 'No bank connections configured yet.',
    'bank_connection_saved'                               => 'Monobank connection saved. Refreshed :count account.|Monobank connection saved. Refreshed :count accounts.',
    'revolut_connection_saved'                            => 'Revolut connection saved. Refreshed :count account.|Revolut connection saved. Refreshed :count accounts.',
    'bank_connection_validated'                           => 'Monobank token is valid.',
    'revolut_connection_validated'                        => 'Revolut token is valid.',
    'bank_accounts_refreshed'                             => 'Monobank accounts refreshed: :count item.|Monobank accounts refreshed: :count items.',
    'revolut_accounts_refreshed'                          => 'Revolut accounts refreshed: :count item.|Revolut accounts refreshed: :count items.',
    'validate_token'                                      => 'Validate token',
    'refresh_accounts'                                    => 'Refresh accounts',
    'monobank_accounts'                                   => 'Monobank accounts',
    'revolut_accounts'                                    => 'Revolut accounts',
    'no_monobank_accounts'                                => 'No Monobank accounts fetched yet.',
    'no_revolut_accounts'                                 => 'No Revolut accounts fetched yet.',
    'mapped_firefly_account'                              => 'Mapped Firefly account',
    'first_import_from_date'                              => 'First import from (optional)',
    'first_import_date_help'                              => 'Only applied before the first successful import.',
    'first_import_date_locked'                            => 'Already imported, date is locked.',
    'not_mapped_yet'                                      => 'Not mapped yet',
    'bank_account_mapping_saved'                          => 'Bank account mapping saved.',
    ...
    'revolut_connection_synced'                           => 'Revolut sync finished. Imported :count transaction.|Revolut sync finished. Imported :count transactions.',
    'bank_connection_sync_queued'                         => 'Monobank sync has been queued and will run in the background.',
    'revolut_connection_sync_queued'                      => 'Revolut sync has been queued and will run in the background.',
    'bank_connection_sync_already_running'                => 'Monobank sync is already running for this connection.',
    'revolut_connection_sync_already_running'             => 'Revolut sync is already running for this connection.',
    'revolut_wallet_id_label'                             => 'Wallet ID',
    'webhook_enabled'                                     => 'Webhook enabled',
    'webhook_registered'                                  => 'Webhook registered',
    'last_successful_sync'                                => 'Last successful sync',
    'sync_now'                                            => 'Sync now',
    'sync_in_progress'                                    => 'Sync in progress',
    'last_sync_imported'                                  => 'Last imported transactions',
    'save_mapping'                                        => 'Save mapping',
    'bank_connection_category_rules'                      => 'Category mapping rules',
    'bank_connection_category_rules_help'                 => 'Rules are applied in this order: specific overrides first, then MCC defaults.',
    'bank_connection_mcc_rules'                           => 'MCC default mappings',
    'bank_connection_override_rules'                      => 'Specific transaction overrides',
    'bank_connection_override_rules_help'                 => 'Use one or more match fields (external ID, description contains, MCC). First matching enabled row wins.',
    'save_category_rules'                                 => 'Save category rules',
    'bank_connection_category_rules_saved'                => 'Bank connection category rules saved.',
    'telegram_assistant_settings'                         => 'Telegram MCP assistant',
    'telegram_assistant_settings_help'                    => 'Link your Telegram user ID and OpenAI settings for @firefly_soteyl_bot. If your Telegram account is not linked yet, the bot will reply with your Telegram user ID.',
    'telegram_user_id'                                    => 'Telegram user ID',
    'telegram_user_id_tooltip'                            => 'Send any message to @firefly_soteyl_bot to get your Telegram user ID, then paste it here.',
    'telegram_assistant_openai_api_token'                 => 'OpenAI API token',
    'telegram_assistant_openai_api_token_help'            => 'Paste your OpenAI API token, or connect through OAuth below.',
    'telegram_assistant_model'                            => 'Model',
    'telegram_assistant_oauth'                            => 'OAuth (optional)',
    'telegram_assistant_oauth_help'                       => 'Click Connect OAuth, complete OpenAI sign-in, then paste the final redirect URL below.',
    'telegram_assistant_oauth_result_url'                 => 'Final OAuth redirect URL',
    'telegram_assistant_oauth_result_url_help'            => 'Paste the full URL from your browser after OAuth (must include state and code).',
    'telegram_assistant_oauth_callback_url'               => 'OAuth redirect URI',
    'telegram_assistant_connect_oauth'                    => 'Connect OAuth',
    'telegram_assistant_save_settings'                    => 'Save Telegram assistant settings',
    'telegram_assistant_settings_saved'                   => 'Telegram assistant settings saved.',
    'telegram_assistant_oauth_url_missing'                => 'OAuth authorize URL is not configured on the server.',
    'telegram_assistant_oauth_state_mismatch'             => 'OAuth callback state mismatch.',
    'telegram_assistant_oauth_missing_api_key'            => 'OAuth callback did not provide a usable token/code.',
    'telegram_assistant_oauth_connected'                  => 'OAuth token received and saved.',
