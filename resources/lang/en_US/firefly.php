...
return [
    ...
    'telegram_assistant_oauth_help'                       => 'Click Connect OAuth, finish the provider flow, then paste the final redirected URL below to save the token.',
    'telegram_assistant_oauth_result_url'                 => 'Final OAuth redirect URL',
    'telegram_assistant_oauth_result_url_help'            => 'Paste the full final URL that contains state and api_key/access_token.',
    'telegram_assistant_oauth_callback_url'               => 'Callback URL',
    ...
    'telegram_assistant_oauth_missing_api_key'            => 'OAuth callback did not provide api_key/access_token.',
