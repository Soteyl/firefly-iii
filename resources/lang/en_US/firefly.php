...
return [
    ...
    'telegram_assistant_oauth_help'                       => 'If your OAuth provider supports redirecting an API key (api_key or access_token), use the callback URL below.',
    'telegram_assistant_oauth_authorize_url'              => 'OAuth authorize URL',
    'telegram_assistant_oauth_redirect_hint'              => 'Redirect URL to set in OAuth provider (optional note field)',
    ...
    'telegram_assistant_oauth_url_missing'                => 'OAuth authorize URL is empty. Save it first.',
